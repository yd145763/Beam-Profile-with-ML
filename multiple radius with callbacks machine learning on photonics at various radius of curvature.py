# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 21:26:12 2023
...
R_actual = pd.Series([30, 50]) #select which radius you want to "remove" here
...
df_actual_label_norm_filtered = df_actual_label_norm[df_actual_label_norm["Radius"] == R_actual_norm[R_index]]

fig = plt.figure(figsize=(7, 4))
ax = plt.axes()
ax.scatter(z, df_actual_label_norm_filtered['horizontal_full'], s=1, color = "blue")
...
fig = plt.figure(figsize=(7, 4))
ax = plt.axes()
ax.scatter(z, df_actual_label_norm_filtered['verticle_full'], s=1, color = "blue")
...
fig = plt.figure(figsize=(7, 4))
ax = plt.axes()
ax.scatter(z, df_actual_label_norm_filtered['max_field_list'], s=1, color = "blue")
