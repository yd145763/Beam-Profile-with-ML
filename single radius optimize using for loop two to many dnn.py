# -*- coding: utf-8 -*-
"""
Created on Sun Jun  4 22:36:23 2023
...
ape_actual_horizontal_count = []
ape_actual_horizontal_std = []
ape_actual_verticle_count = []
ape_actual_verticle_std = []
train_test_ape = []
...
for dense_layer in dense_layers:
    for layer_size in layer_sizes:
        ...
        pred_horizontal_count_denorm = [(i*(max_horizontal_count-min_horizontal_count))+min_horizontal_count for i in predictions[:,3]]
        actual_horizontal_count_denorm = df_main[df_main["Radius"] == R_actual]['horizontal_count']
        
        pred_horizontal_std_denorm = [(i*(max_horizontal_std-min_horizontal_std))+min_horizontal_std for i in predictions[:,4]]
        actual_horizontal_std_denorm = df_main[df_main["Radius"] == R_actual]['horizontal_std']
        
        pred_verticle_count_denorm = [(i*(max_verticle_count-min_verticle_count))+min_verticle_count for i in predictions[:,5]]
        actual_verticle_count_denorm = df_main[df_main["Radius"] == R_actual]['verticle_count']
        
        pred_verticle_std_denorm = [(i*(max_verticle_std-min_verticle_std))+min_verticle_std for i in predictions[:,5]]
        actual_verticle_std_denorm = df_main[df_main["Radius"] == R_actual]['verticle_std']
        ...
        rel_error = diff / actual_max_field_list_denorm
        pct_error = rel_error * 100
        ape = pct_error.mean()
        ...
        diff = (actual_horizontal_count_denorm - pred_horizontal_count_denorm).abs()
        rel_error = diff / actual_horizontal_count_denorm
        pct_error = rel_error * 100
        ape = pct_error.mean()
        ape_actual_horizontal_count.append(ape)
        
        fig = plt.figure(figsize=(7, 4))
        ax = plt.axes()
        ax.scatter(z, actual_horizontal_count_denorm, s=1, color = "blue")
        ax.plot(z, pred_horizontal_count_denorm, color = "red")
        #graph formatting     
        ax.tick_params(which='major', width=2.00)
        ax.tick_params(which='minor', width=2.00)
        ax.xaxis.label.set_fontsize(15)
        ...
        plt.ylabel("Max E-field (eV)")
        plt.legend(["Original Data", "Predicted Data"], prop={'weight': 'bold','size': 10}, loc = "upper left")
        plt.title("horizontal_count\n"+NAME+"\n", fontweight = 'bold')
        plt.show()
        plt.close()
        print(" ")
        print(" ")
        print(" ")
        print("Mean Absolute Error horizontal_count", mean_absolute_error(actual_horizontal_count_denorm, pred_horizontal_count_denorm))
        print(" ")
        print(" ")
        print(" ")
        
        diff = (actual_horizontal_std_denorm - pred_horizontal_std_denorm).abs()
        rel_error = diff / actual_horizontal_std_denorm
        pct_error = rel_error * 100
        ape = pct_error.mean()
        ape_actual_horizontal_std.append(ape)
        
        fig = plt.figure(figsize=(7, 4))
        ax = plt.axes()
        ax.scatter(z, actual_horizontal_std_denorm, s=1, color = "blue")
        ax.plot(z, pred_horizontal_std_denorm, color = "red")
        #graph formatting     
        ax.tick_params(which='major', width=2.00)
        ax.tick_params(which='minor', width=2.00)
        ax.xaxis.label.set_fontsize(15)
        ...
        plt.ylabel("Max E-field (eV)")
        plt.legend(["Original Data", "Predicted Data"], prop={'weight': 'bold','size': 10}, loc = "upper left")
        plt.title("horizontal_std\n"+NAME+"\n", fontweight = 'bold')
        plt.show()
        plt.close()
        print(" ")
        print(" ")
        print(" ")
        print("Mean Absolute Error horizontal_std", mean_absolute_error(actual_horizontal_std_denorm, pred_horizontal_std_denorm))
        print(" ")
        print(" ")
        print(" ")
        
        diff = (actual_verticle_count_denorm - pred_verticle_count_denorm).abs()
        rel_error = diff / actual_verticle_count_denorm
        pct_error = rel_error * 100
        ape = pct_error.mean()
        ape_actual_verticle_count.append(ape)
        
        fig = plt.figure(figsize=(7, 4))
        ax = plt.axes()
        ax.scatter(z, actual_verticle_count_denorm, s=1, color = "blue")
        ax.plot(z, pred_verticle_count_denorm, color = "red")
        #graph formatting     
        ax.tick_params(which='major', width=2.00)
        ax.tick_params(which='minor', width=2.00)
        ax.xaxis.label.set_fontsize(15)
        ...
        plt.ylabel("Max E-field (eV)")
        plt.legend(["Original Data", "Predicted Data"], prop={'weight': 'bold','size': 10}, loc = "upper left")
        plt.title("verticle_count\n"+NAME+"\n", fontweight = 'bold')
        plt.show()
        plt.close()
        print(" ")
        print(" ")
        print(" ")
        print("Mean Absolute Error verticle_count", mean_absolute_error(actual_verticle_count_denorm, pred_verticle_count_denorm))
        print(" ")
        print(" ")
        print(" ")
        
        diff = (actual_verticle_std_denorm - pred_verticle_std_denorm).abs()
        rel_error = diff / actual_verticle_std_denorm
        pct_error = rel_error * 100
        ape = pct_error.mean()
        ape_actual_verticle_std.append(ape)
        
        fig = plt.figure(figsize=(7, 4))
        ax = plt.axes()
        ax.scatter(z, actual_verticle_std_denorm, s=1, color = "blue")
        ax.plot(z, pred_verticle_std_denorm, color = "red")
        #graph formatting     
        ax.tick_params(which='major', width=2.00)
        ax.tick_params(which='minor', width=2.00)
        ax.xaxis.label.set_fontsize(15)
        ...
        plt.ylabel("Max E-field (eV)")
        plt.legend(["Original Data", "Predicted Data"], prop={'weight': 'bold','size': 10}, loc = "upper left")
        plt.title("verticle_std\n"+NAME+"\n", fontweight = 'bold')
        plt.show()
        plt.close()
        print(" ")
        print(" ")
        print(" ")
        print("Mean Absolute Error verticle_std", mean_absolute_error(actual_verticle_std_denorm, pred_verticle_std_denorm))
        print(" ")
        print(" ")
        print(" ")
...
df_mae["ape_actual_horizontal_count"] = ape_actual_horizontal_count
df_mae["ape_actual_horizontal_std"] = ape_actual_horizontal_std
df_mae["ape_actual_verticle_count"] = ape_actual_verticle_count
df_mae["ape_actual_verticle_std"] = ape_actual_verticle_std
...
ax.set_yticklabels(ax.get_yticklabels(), fontweight="bold", fontsize = 12)
sns.heatmap(mat, annot=True, cmap='hot', annot_kws={"fontsize":10, "fontweight":"bold"}, fmt=".1f")
ax.set_title('ape_actual_max_field_list\n\n\n\n', fontweight = 'bold')
cbar = ax.collections[0].colorbar
cbar.ax.tick_params(labelsize=12, width=2, length=6, pad=10, direction="out", colors="black", labelcolor="black")
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
...
mat = df_mae.pivot('number of layers', 'number of nodes first layer', 'ape_actual_horizontal_count')
fig, ax = plt.subplots()
ax.set_xticklabels(ax.get_xticklabels(), fontweight="bold", fontsize = 12)
ax.set_yticklabels(ax.get_yticklabels(), fontweight="bold", fontsize = 12)
sns.heatmap(mat, annot=True, cmap='hot', annot_kws={"fontsize":10, "fontweight":"bold"}, fmt=".1f")
ax.set_title('ape_actual_horizontal_count\n\n\n\n', fontweight = 'bold')
cbar = ax.collections[0].colorbar
cbar.ax.tick_params(labelsize=12, width=2, length=6, pad=10, direction="out", colors="black", labelcolor="black")
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
...
mat = df_mae.pivot('number of layers', 'number of nodes first layer', 'ape_actual_horizontal_std')
fig, ax = plt.subplots()
ax.set_xticklabels(ax.get_xticklabels(), fontweight="bold", fontsize = 12)
ax.set_yticklabels(ax.get_yticklabels(), fontweight="bold", fontsize = 12)
sns.heatmap(mat, annot=True, cmap='hot', annot_kws={"fontsize":10, "fontweight":"bold"}, fmt=".1f")
ax.set_title('ape_actual_horizontal_std\n\n\n\n', fontweight = 'bold')
cbar = ax.collections[0].colorbar
cbar.ax.tick_params(labelsize=12, width=2, length=6, pad=10, direction="out", colors="black", labelcolor="black")
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
...
mat = df_mae.pivot('number of layers', 'number of nodes first layer', 'ape_actual_verticle_count')
fig, ax = plt.subplots()
ax.set_xticklabels(ax.get_xticklabels(), fontweight="bold", fontsize = 12)
ax.set_yticklabels(ax.get_yticklabels(), fontweight="bold", fontsize = 12)
sns.heatmap(mat, annot=True, cmap='hot', annot_kws={"fontsize":10, "fontweight":"bold"}, fmt=".1f")
ax.set_title('ape_actual_verticle_count\n\n\n\n', fontweight = 'bold')
cbar = ax.collections[0].colorbar
cbar.ax.tick_params(labelsize=12, width=2, length=6, pad=10, direction="out", colors="black", labelcolor="black")
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
...
mat = df_mae.pivot('number of layers', 'number of nodes first layer', 'ape_actual_verticle_std')
fig, ax = plt.subplots()
ax.set_xticklabels(ax.get_xticklabels(), fontweight="bold", fontsize = 12)
ax.set_yticklabels(ax.get_yticklabels(), fontweight="bold", fontsize = 12)
sns.heatmap(mat, annot=True, cmap='hot', annot_kws={"fontsize":10, "fontweight":"bold"}, fmt=".1f")
ax.set_title('ape_actual_verticle_std\n\n\n\n', fontweight = 'bold')
cbar = ax.collections[0].colorbar
cbar.ax.tick_params(labelsize=12, width=2, length=6, pad=10, direction="out", colors="black", labelcolor="black")
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
